...
class _MessageViewState extends State<MessageView> with WidgetsBindingObserver {
  ...
  Widget _singleMessage(BuildContext context, int num) {
    ...
    /*TO DELETE FOR VERSION WITH PICTURE*/
    if (_messageList[num].isPicture != null) {
      if (_messageList[num].isPicture!) {
        return Card();
      }
    }
    return Card(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (_messageList[num].isPicture! != true && (_messageList[num].flag != true)) Text(_messageList[num].message),
            //if (_messageList[num].isPicture != null && _messageList[num].flag != true && _messageList[num].isPicture!)
